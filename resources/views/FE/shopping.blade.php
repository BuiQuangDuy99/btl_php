        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <ul>
                        <li><a href="#">Trái cây Mỹ</a></li>
                        <li><a href="#">Trái cây Nhật Bản</a></li>
                        <li><a href="#">Trái cây Úc</a></li>
                        <li><a href="#">Trái cây New Zealand</a></li>
                        <li><a href="#">Trái cây Chile</a></li>
                        <li><a href="#">Trái cây Việt Nam</a></li>
                        <li><a href="#">Trái cây Nam Phi</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-9">
...
<section class="breadcrumb-section set-bg" data-setbg="{{ asset('FE/img/breadcrumb.jpg') }}" style="background-image: url(&quot;img/breadcrumb.jpg&quot;);">
        <div class="container">
            <div class="row">
